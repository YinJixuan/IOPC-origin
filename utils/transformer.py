...
#         else:
#             sa_output, weight = self._sa_block(x, src_mask, src_key_padding_mask, is_causal=is_causal)
...
_all__ = ['Transformer', 'TransformerEncoder', 'TransformerDecoder', 'TransformerEncoderLayer', 'TransformerDecoderLayer']
